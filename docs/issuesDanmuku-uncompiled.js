(function (global, factory) {
  ...
  (global = global || self, global.IssuesDanmuku = factory());
  ...
  var localforage$1 = createCommonjsModule(function (module, exports) {
  /*!
  ...
  */
  ...
  localforage$1.config({
    driver: [localforage$1.WEBSQL, localforage$1.INDEXEDDB, localforage$1.LOCALSTORAGE],
    name: 'issues-danmuku'
  });
  ...
  /*#__PURE__*/
  function () {
    function IssuesDanmuku(options) {
      classCallCheck(this, IssuesDanmuku);

      this.options = Object.assign({}, IssuesDanmuku.DEFAULT, options);
      this.init();
    }

    createClass(IssuesDanmuku, [{
      key: "init",
      value: function () {
          ...
          return regenerator.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _context.next = 2;
                  return localforage$1.getItem('userInfo');

                case 2:
                  this.userInfo = _context.sent;
                  _context.next = 5;
                  return localforage$1.getItem('token');
                ...
                case 11:
                  ...
                  _context.next = 15;
                  return localforage$1.setItem('token', data.access_token);
                ...
                case 17:
                  ...
                  _context.next = 21;
                  return localforage$1.setItem('userInfo', userInfo);

                case 21:
                  _context.next = 23;
                  return localforage$1.getItem('redirect_uri');
          ...
          return regenerator.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  _context2.next = 2;
                  return localforage$1.setItem('redirect_uri', window.location.href);
      ...
      value: function () {
        ...
        /*#__PURE__*/
        regenerator.mark(function _callee3(method, url, body) {
          var headers, res;
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                ...
                case 10:
                  ...
                  return _context3.abrupt("return", Promise.reject('Unauthorized.'));
                ...
                case 15:
                  ...
                  return _context3.abrupt("return", localforage.clear().then(window.location.reload));
      ...
      key: "urlQuery",
      value: function urlQuery(options) {
        return objectSpread({
          client_id: this.options.clientID,
      ...
      value: function getToken(code) {
        ...
        return this.request('get', "".concat(this.options.proxy, "?").concat(queryStringify(query)));
      }
    }, {
      key: "getUserInfo",
      value: function getUserInfo(token) {
        return this.request('get', "https://api.github.com/user?access_token=".concat(token));
      }
    }, {
      key: "send",
      value: function () {
        ...
        /*#__PURE__*/
        regenerator.mark(function _callee4(msg) {
          var videoTime,
              query,
              data,
              _args4 = arguments;
          return regenerator.wrap(function _callee4$(_context4) {
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  videoTime = _args4.length > 1 && _args4[1] !== undefined ? _args4[1] : 0;
                  query = this.urlQuery({
                    body: JSON.stringify({
                      sendTime: Date.now(),
                ...
                case 4:
                  ...
                  return _context4.abrupt("return", danmuFormat(data));
            ...
            while (1) {
              switch (_context5.prev = _context5.next) {
                ...
                case 5:
                  ...
                  return _context5.abrupt("return", danmuFormat(result));
...
//# sourceMappingURL=issuesDanmuku-uncompiled.js.map
