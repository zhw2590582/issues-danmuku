(function (global, factory) {
  ...
  var storageName = 'danmuku_settings';
  ...
  function throwError(condition, msg, callback) {
    if (!condition) {
      callback && callback();
      throw new Error("Danmuku Error: ".concat(msg));
    }
  }
  ...
  function () {
    ...
    createClass(IssuesDanmuku, [{
      ...
      value: function () {
        ...
        /*#__PURE__*/
        regenerator.mark(function _callee2(method, url, body) {
          var headers, res;
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 7:
                  ...
                  return _context2.abrupt("return", Promise.reject(new Error('Unauthorized')));
                ...
                case 15:
                  return _context2.abrupt("return", window.location.reload());
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                ...
                case 2:
                  ...
                  throwError(Array.isArray(result), 'Can not get the danmuku, Please try again!');
          ...
          return regenerator.wrap(function _callee4$(_context4) {
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  danmu = _args4.length > 0 && _args4[0] !== undefined ? _args4[0] : {};
                  query = this.urlQuery({
                ...
                case 4:
                  ...
                  return _context4.abrupt("return", JSON.parse(data.body));
